...
//	}
	 ...
	 * @param dayOfMonth
	 *            the day of the Jewish month to validate. It will reject any value < 1 or > 30 Note: check calling
	 ...
	 *            since calling methods will simply set it to the maximum for that month. Note: check calling methods to
