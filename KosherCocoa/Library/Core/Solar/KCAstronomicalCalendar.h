 ...
 *
 *  The default calculator is the KCNOAACalculator. However, you can use the KCSunriseAndSunsetCalculator as well.
 */

@property (nonatomic, strong, nonnull) KCNOAACalculator *astronomicalCalculator;
