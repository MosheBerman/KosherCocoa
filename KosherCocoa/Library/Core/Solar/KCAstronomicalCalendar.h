...
/**
 Calcuates the beginning of civil twilight.
 
 @return An `NSDate` marking the beginning of civil twilight on the date representing by `workingDate`.
 */
- (nullable NSDate *)beginCivilTwilight;


/**
 Calcuates the beginning of nautical twilight.
 
 @return An `NSDate` marking the beginning of nautical twilight on the date representing by `workingDate`.
 */
- (nullable NSDate *)beginNauticalTwilight;

/**
 Calcuates the beginning of astronomical twilight.
 
 @return An `NSDate` marking the beginning of astronomical twilight on the date representing by `workingDate`.
 */
...
/**
 ...
 @param offsetZenith the degrees after sunset to use in the calculation. For time before sunset use negative numbers. Note that the degree offset is from the vertical, so for a calculation of 14 degrees.
