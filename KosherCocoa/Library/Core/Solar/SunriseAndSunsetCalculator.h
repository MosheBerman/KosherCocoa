...
@interface SunriseAndSunsetCalculator : AstronomicalCalculator
 ...
 *
 *  - Year: a 4 digit gregorian year
 *
 *  - Month: month of the gregorian year 1-12
 *
 *  - Day: day of the gregorian month, 1-31
 *
