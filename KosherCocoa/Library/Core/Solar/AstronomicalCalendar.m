...
- (id) initWithLocation:(GeoLocation *)AGeoLocation{
    ...
    if (self) {
        ...
        SunriseAndSunsetCalculator *tempCalc = [[SunriseAndSunsetCalculator alloc] initWithGeoLocation:AGeoLocation];
...
- (double) UTCSeaLevelSunrise:(double)zenith{
    double sunrise = [((SunriseAndSunsetCalculator *)self.astronomicalCalculator) UTCSunriseForDate:self.workingDate andZenith:zenith adjustForElevation:NO]; 
