    ...
    if (data == nil)
    {
         data = @{
                               ...
                               NSStringFromSelector(@selector(shaahZmanisAteretTorah)) : @{
                                       ...
                                       @"koshercocoa.explanation.english" : @"Method to return a temporal hour according to the opinion of the Chacham Yosef Harari-Raful of Yeshivat Ateret Torah calculated with alos being 1/10th of sunrise to sunset day, or 72 minutes zmaniyos of such a day before sunrise, and tzais is usually calculated as 40 minutes (configurable to any offset by modifying AteretTorahSunsetOffset) after sunset. This day is split into 12 equal parts with each part being a shaah zmanis. Note that with this system, chatzos (mid-day) will not be the point that the sun is halfway across the sky."
                                       },
                               NSStringFromSelector(@selector(shaahZmanis120Minutes)) : @{
                               ...
                               NSStringFromSelector(@selector(shaahZmanis120MinutesZmanis))  : @{
                                       ...
                                       @"koshercocoa.explanation.english" : @"The time of plag hamincha based on sunrise being 120 minutes zmaniyos (GRA and the Baal Hatanya) or 1/6th of the day before sea level sunrise. This is calculated as 10.75 hours after dawn. The formula used is: 10.75 x ShaahZmanis120MinutesZmanis after dawn."
                                       },
                               ...
                               NSStringFromSelector(@selector(alos72Zmanis))  : @{
                                       @"koshercocoa.name.hebrew" : @"(åעלות (72 דקות זמניות",
                               ...
                               NSStringFromSelector(@selector(sofZmanShmaMogenAvraham)) : @{
                                       ...
                                       @"koshercocoa.explanation" : @"This method returns the latest zman krias shema (time to recite shema in the morning) in the opinion of the MGA based on alos being 72 minutes before sunrise. This time is 3 shaos zmaniyos (solar hours) after dawn based on the opinion of the Mogen Avraham that the day is calculated from a dawn of 72 minutes before sunrise to nightfall of 72 minutes after sunset."
                                       },
                               NSStringFromSelector(@selector(sofZmanShmaFixedLocal)) : @{
                                       ...
                                       @"koshercocoa.explanation" : @"A method that returns the latest zman krias shema (time to recite Shema in the morning) calculated as 3 hours before fixed local chatzos."
                                       },
                               ...
                               NSStringFromSelector(@selector(sofZmanShma3HoursBeforeChatzos)) : @{
                                       @"koshercocoa.name.hebrew" : @"סוף זמן קריאת שמע (3 שעות לפנחי חצות)",
                                       @"koshercocoa.name.transliterated.ashkenaz" : @"",
                                       @"koshercocoa.name.transliterated.sepharad" : @"",
                                       @"koshercocoa.name.english" : @"Latest time to recite Kriyas Sh'ma (3 Hours before chatzot)",
                                       @"koshercocoa.explanation" : @"This method returns the latest zman krias shema (time to recite Shema in the morning) calculated as 3 hours (regular and not zmaniyos) before chatzos. This is the opinion of the Shach in the Nekudas Hakesef (Yora Deah 184), Shevus Yaakov, Chasam Sofer and others."
                                       },
                               NSStringFromSelector(@selector(sofZmanShmaMGA120Minutes)) : @{
